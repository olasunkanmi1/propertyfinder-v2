...
const DesktopAndTabs = () => {
  ...
  return (
    <div className="hidden md:flex flex-col justify-between items-center bg-dubai bg-contain w-full space-y-8 rounded-3xl text-white p-4">
        ...
        <div className="flex flex-wrap gap-5 justify-center p-4 w-full lg:w-[900px] rounded-xl bg-[#000] bg-opacity-60 mx-auto overflow-auto">
            {filterData.map((filter) => {
                ...
                return (
                    <div 
                        ...
                        className="flex items-center justify-between bg-white rounded-md text-gray-600 py-2 px-4 text-md font-medium cursor-pointer relative w-[200px]"
