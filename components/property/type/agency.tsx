      ...
      { agency && (
        <>
          ...
          <div className="flex space-x-2 justify-center items-center w-[25px] h-[25px] relative rounded-full overflow-hidden border bg-secondary text-white">
              <Image 
                  src={agency && agency.logo && agency.logo.url ? agency.logo.url : 'https://i.ibb.co/6vv08Pk/homr-removebg-preview.png'} alt="Agency Logo" fill priority 
                  blurDataURL={agency && agency.logo && agency.logo.url ? agency.logo.url : 'https://i.ibb.co/6vv08Pk/homr-removebg-preview.png'}
              />
          </div>
        </>
      ) }
